...
from utils.datasets import create_dataloader, extract_boxes
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if opt.save_boxes:
        p = Path(train_path).parent.parent
        extract_boxes(p)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./pretrain/yolor-p6-paper-541.pt', help='initial weights path')
    ...
    parser.add_argument('--save-boxes', action='store_true', help='extract object detection boxes for second stage classifier')
